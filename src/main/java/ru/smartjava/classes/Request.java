...
public class Request {
    ...
    public List<String> getPostParam(String name)  {
        if(getParams() != null) {
            return getPostParams().stream().filter(pair -> Objects.equals(pair.getName(), name)).map(NameValuePair::getValue).collect(Collectors.toList());
        }
        return null;
    }
    ...
    public List<String> getParam(String name)  {
        if(getParams() != null) {
            return getParams().stream().filter(pair -> Objects.equals(pair.getName(), name)).map(NameValuePair::getValue).collect(Collectors.toList());
        }
        return null;
    }
